...
export const viewTypes: string[] = [
  "A sweeping aerial view",
  "A close-up of surreal terrain",
  "A panoramic wide shot",
  "A distant silhouette view",
  "A god's-eye perspective",
  "A cinematic long shot",
  "A macro view of a strange ecosystem",
  "A painting-like composition",
  "A horizon line split by color",
  "A reflection in rippling water",
  "A dreamlike time-lapse perspective",
  "A cross-section cutaway of the landscape",
  "A layered perspective through mist and light",
  "A sideways scrolling parallax view",
  "A kaleidoscopic reinterpretation of the terrain",
  "A scene viewed through fractured glass",
  "A mirrored twin-world vista",
  "A worm's-eye view from the ground",
  "A frozen moment caught mid-transformation",
  "A light-warped perspective bending space",
  "A solar eclipse revealing hidden shapes",
  "A view from inside a translucent structure",
  "A vast reflection viewed through water droplets",
  "A long exposure shot capturing streaks of motion",
  "A tilt-shift illusion making giants seem tiny",
  "A blurred dream seen through half-closed eyes",
  "A vast scene viewed from a crumbling balcony",
  "A glowing shape forming in heavy fog",
  "A moment suspended in gravity-defying stillness",
  "A looping landscape trapped in time",
  "A tunnel-like perspective leading toward infinity",
  "A view seen through the eyes of a creature",
  "A celestial map projected across the sky",
  "A radial view spiraling out from the center",
  "A distant land framed by craggy stone arches",
  "A tranquil scene seen through stained glass",
  "A birds-eye view framed by wings in motion",
  "A towering perspective looking up through vines",
  "A distorted lens view through fluid orbs",
  "A landscape unrolling like a scroll",
  "A painter's canvas coming to life",
  "A natural formation shaped like a symbol",
  "A shattered view through cracked ice or stone",
  "A window-like slice of a much larger world",
];

export const viewSubjects: string[] = [
  // Original entries
  "a vast crystalline forest",
  "spiraling cloud towers",
  "a colossal broken statue",
  "bioluminescent coral fields",
  "a massive tree reaching into the stars",
  "intertwined floating islands",
  "an ancient stairway carved into a canyon",
  "a gleaming alien cityscape",
  "sand dunes shaped like waves",
  "a glowing river cutting through glass plains",
  "a hollow moon with lights inside",
  "a sacred stone circle surrounded by fireflies",
  "mirrored mountains with impossible geometry",
  "a bridge of roots stretching across the sky",
  "a frozen waterfall defying gravity",
  "a labyrinth of stone and light",
  "a neon-lit skyline veiled in smog",
  "ruins suspended over an endless abyss",

  // New additions — Fantasy / Nature
  "a field of giant flowers swaying in unison",
  "a living mountain shaped like a beast",
  "a canyon filled with golden fog",
  "a grove of trees with glowing veins",
  "a temple buried in a living jungle",
  "a cliffside waterfall falling upward",
  "a series of floating stone rings",
  "a crystal monolith piercing the sky",
  "a sea of grass whispering secrets",
  "a desert of glass shards under twin suns",
  "a spiral tower grown from bone and vine",
  "a path of stepping stones over a glowing marsh",
  "a volcano with ice pouring from its rim",
  "an ancient lighthouse lit with soulfire",
  "a great serpent carved into the hills",
  "a forest of petrified lightning strikes",

  // Sci-Fi / Tech / Alien
  "a collapsed orbital ring encircling the planet",
  "an abandoned megastructure half-sunk in sand",
  "a city made entirely of mirrored surfaces",
  "a Dyson sphere cracked open to reveal its core",
  "a terraformed moon covered in mossy architecture",
  "a shipyard orbiting a blue giant star",
  "a transit ring spinning above molten plains",
  "a swarm of data constructs shaped like birds",
  "a planet-sized satellite dish embedded in terrain",
  "a glowing grid of energy pylons stretching to the horizon",
  "a quantum crater warping time at its center",
  "an archive tower built from light itself",
  "an alien hive with geometric symmetry",
  "a space elevator dissolving into clouds",
  "a robotics graveyard blooming with metallic flowers",

  // Surreal / Magical / Abstract
  "a mirror lake that reflects the future",
  "a staircase looping into the sky",
  "a constellation projected on the ground",
  "a landscape stitched together from dreams",
  "a giant eye embedded in a cliffside",
  "a cave entrance shaped like a screaming face",
  "a river of ink winding through blank terrain",
  "a cracked sphere hovering above a crater",
  "a bridge built from starlight",
  "a sandstorm frozen mid-surge",
  "a mountain carved like origami",
  "a town where every house is upside down",
  "a horizon that folds into itself",
  "a ghostly carnival appearing in the fog",
  "a giant clockwork sun suspended by chains",

  // Architectural / Constructed
  "a towering ziggurat wrapped in vines",
  "a network of bridges between sky spires",
  "an endless library open to the sky",
  "a cathedral built on the edge of nothingness",
  "a city carved into the bones of a giant",
  "a flooded amphitheater glowing from below",
  "an observatory watching falling stars",
  "a coliseum reclaimed by nature",
  "a floating marketplace drifting between airships",
  "an abandoned mansion with flickering windows",
  "a labyrinthine castle stretching into fog",
  "an ancient aqueduct arcing over the clouds",
];

export const visualStyles: string[] = [
  // Original entries
  "arranged in impossible symmetry",
  "woven together like a tapestry",
  "towering over everything in sight",
  "reflected perfectly in still water",
  "framed by spiraling clouds",
  "tilted at unnatural angles",
  "interlocked like puzzle pieces",
  "layered with intricate shadows",
  "split by glowing lines of energy",
  "collapsing into a beautiful mess",
  "emerging from dense mist",
  "bending space around it",
  "floating in fragmented gravity",
  "radiating color like a prism",
  "half-submerged beneath shimmering glass",

  // New additions — Structure/Shape
  "twisting upward like a corkscrew",
  "folded into an infinite loop",
  "sprawling out in fractal patterns",
  "spiraling around a central void",
  "woven through itself like a knot",
  "stacked in delicate balance",
  "mirrored along a vertical axis",
  "cut into perfect geometric shapes",
  "rising in layers like a wedding cake",
  "fanned out like a peacock's tail",
  "shaped like an ancient symbol",
  "split into mirrored realms",
  "curving along a golden ratio arc",
  "radiating outward from a glowing point",
  "nestled inside concentric rings",

  // Motion-based or Dynamic
  "flickering between states of matter",
  "shifting subtly with time",
  "flowing like liquid architecture",
  "frozen mid-collapse",
  "rising from the earth in slow motion",
  "hovering as if caught in a breath",
  "cycling through seasons in real-time",
  "dripping like wet paint",
  "unfolding like origami in motion",
  "caught in a gravitational swirl",

  // Metaphorical / Abstract
  "as if sketched by a dreaming architect",
  "like a memory frozen in crystal",
  "folded like a paper dream",
  "stitched together from multiple realities",
  "melting into the surrounding space",
  "cracked like an old photograph",
  "pulsing softly with awareness",
  "as if listening to the wind",
  "built from echoes and light",
  "worn down by forgotten time",

  // Stylized or Cinematic
  "bathed in painterly strokes",
  "composed like a cathedral fresco",
  "glowing as if rendered in neon ink",
  "etched in shifting shadowplay",
  "rendered in sharp architectural lines",
  "dripping with visual noise",
  "photographed at golden hour",
  "composed with brutalist minimalism",
  "outlined by starlight",
  "as if sculpted from music",
];